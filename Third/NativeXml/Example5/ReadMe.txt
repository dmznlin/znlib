...
A trial version of NativeXml is available for free. The required unit NativeXml.dcu is already included in this demo.

How to compile
==============

- Put NativeXmlObjectStorage.dcu and NativeXml.dcu in the demo folder.
