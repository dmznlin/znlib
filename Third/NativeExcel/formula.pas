...
uses
  system.SysUtils, Classes, xlshash, xlsBlob, xlsExtern, xlsstrb;
   ...
   LT_NUMBER, LT_STRING, LT_RANGE, LT_3DRANGE:
       case lLex of
            LT_NUMBER:  begin
                          ...
                          if FormatSettings.DecimalSeparator <> FDecimalSeparator then
                          begin
                             Item.Value := StringReplace(Item.Value, FDecimalSeparator, FormatSettings.DecimalSeparator, [rfReplaceAll])
                          end; 
