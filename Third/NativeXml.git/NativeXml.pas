...

{
  ...
  public
    ...
    function NodeByNameR(const AName: Utf8String): TXmlNode;
    ...
    //raise exception when result is nil
    function FindNodeR(const NodeName: Utf8String): TXmlNode;
...
function TXmlNode.NodeByNameR(const AName: Utf8String): TXmlNode;
begin
...
function TXmlNode.FindNodeR(const NodeName: Utf8String): TXmlNode;
begin
