...
// (DO NOT EDIT: machine generated header) 'ComPortP.dpk' rev: 32.00 (Windows)
...
#include <SysInit.hpp>
#include <ComPort.hpp>
#include <ComPortE.hpp>
#include <ComSignal.hpp>
#include <ComSignalE.hpp>
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_COMPORTP)
using namespace Comportp;
#endif
#pragma pack(pop)
#pragma option pop
